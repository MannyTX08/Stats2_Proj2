...
# use glmnet to fit a binomial logistic regression
glmnetfit <- cv.glmnet(GLMTrain.x, GLMTrain.y, family = "binomial", alpha=1, type.measure = "mse")
...
# use glmnet to fit a binomial logistic regression
glmnetfit <- cv.glmnet(GLMTrain.x, GLMTrain.y, family = "binomial", alpha=1, type.measure = "class")
...
# Significant coefficients are:
# Fare, Family, Pclass, Sex, SibSp, Embarked, Title, AgeBin
